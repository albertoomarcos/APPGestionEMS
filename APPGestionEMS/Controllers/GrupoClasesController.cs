...
namespace APPGestionEMS.Controllers
{
    ...
    public class GrupoClasesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,NumAlumnos")] GrupoClases grupoClases)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,NumAlumnos")] GrupoClases grupoClases)
        {
            if (ModelState.IsValid)
            {
